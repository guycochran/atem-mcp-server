...
export function registerTransitionTools(server) {
    server.registerTool('atem_set_transition_style', {
...
Args:
  ...
  - me (number, optional): Mix Effect bus number (default: 0 for ME1)`,
    ...
    server.registerTool('atem_set_transition_rate', {
...
Args:
  ...
  - me (number, optional): Mix Effect bus number (default: 0 for ME1)`,
    ...
    server.registerTool('atem_set_transition_position', {
...
Args:
  ...
  - me (number, optional): Mix Effect bus number (default: 0 for ME1)`,
    ...
    server.registerTool('atem_get_transition_state', {
