...
export function registerMacroTools(server) {
    server.registerTool('atem_macro_run', {
        title: 'Run Macro',
...
Args:
  - index (number): Macro slot number (0-based, so macro 0 = first macro slot)`,
    ...
    server.registerTool('atem_macro_stop', {
        title: 'Stop Macro',
    ...
    server.registerTool('atem_macro_continue', {
    ...
    server.registerTool('atem_list_macros', {
        title: 'List Macros',
...
export function registerRecordingStreamingTools(server) {
    server.registerTool('atem_start_recording', {
    ...
    server.registerTool('atem_stop_recording', {
    ...
    server.registerTool('atem_start_streaming', {
    ...
    server.registerTool('atem_stop_streaming', {
    ...
    server.registerTool('atem_get_recording_status', {
...
//# sourceMappingURL=macros-recording.js.map