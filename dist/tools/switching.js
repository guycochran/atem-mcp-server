...
export function registerSwitchingTools(server) {
    server.registerTool('atem_set_program', {
...
Common input IDs: 1-20 = physical inputs, 1000 = color bars, 2001/2002 = color generators, 3010/3020 = media players, 6000 = super source, 10010 = black.`,
    ...
    server.registerTool('atem_set_preview', {
...
Args:
  - me (number, optional): Mix Effect bus number (default: 0 for ME1)`,
    ...
    server.registerTool('atem_auto_transition', {
...
Args:
  - me (number, optional): Mix Effect bus number (default: 0 for ME1)`,
    ...
    server.registerTool('atem_fade_to_black', {
        title: 'Fade to Black',
...
Args:
  - me (number, optional): Mix Effect bus number (default: 0 for ME1)`,
    ...
    server.registerTool('atem_preview_and_auto', {
